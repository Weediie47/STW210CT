...
public class View {
	...
	View() {
		...
		lNo = new JLabel("Available Books:" + book.size());
		f.add(lNo);
		...
		btnUpdate.addActionListener(e -> {
			...
			if (row >= 0) {
				...
				JButton btnChange = new JButton("Update Book");
				f.add(btnChange);
				btnChange.setBounds(300, 650, 150, 30);

				JButton btnCancel = new JButton("Cancel");
				f.add(btnCancel);
				btnCancel.setBounds(450, 650, 150, 30);
		...
		f.add(tfbSearch);
		tfbSearch.setBounds(50, 60, 180, 30);

		btnSearch = new JButton("Search");
		f.add(btnSearch);
		btnSearch.setBounds(230, 60, 90, 29);
		...
		f.add(btnSell);
		btnSell.setBounds(170, 550, 130, 30);
